...
public class MangaRepository {
    private static final List<Manga> mangas = List.of(new Manga(1, "Dragon Ball Z", 326), new Manga(2, "Dragon Ball Super", 425));

    public static Optional<Manga> findById(Integer id){
        return findBy(s -> s.getId().equals(id));
    }

    public static Optional<Manga> findByTitle(String title){ return findBy(s -> s.getTitle().equalsIgnoreCase(title));}
